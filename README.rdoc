...
* standard/healthcheck (default) - site, database and migrations checks are run plus email if ActionMailer is defined and it is not using the default configuration
...
Add the following line to Gemfile
    ...
    gem "health_check", git: 'https://github.com/oiahoon/health_check'
...
You may call add_custom_check multiple times with different tests. These tests will be included in the default list ("standard" or "healthcheck").
